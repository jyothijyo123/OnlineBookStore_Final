...
<div className="row">
            <div className="card m-5" style={{width: "15rem"}}>
  <img src="/img/product-1.jpg" className="card-img-top" style={{height:"15rem"}} alt="..."/>
...
<div class="card m-5" style={{width: "15rem"}}>
  <img src="/img/product-2.jpg" class="card-img-top" style={{height:"15rem"}} alt="..."/>
  <div class="card-body">
...
<div class="card m-5" style={{width: "15rem"}}>
  <img src="/img/product-3.jpg" class="card-img-top" style={{height:"15rem"}} alt="..."/>
  <div class="card-body">
...
<div class="card m-5" style={{width: "15rem"}}>
  <img src="/img/product-4.jpg" class="card-img-top" style={{height:"15rem"}} alt="..."/>
  <div class="card-body">
...
<div class="card m-5" style={{width: "15rem"}}>
  <img src="/img/product-5.jpg" class="card-img-top" style={{height:"15rem"}} alt="..."/>
  <div class="card-body">
...
<div class="card m-5" style={{width: "15rem"}}>
  <img src="/img/product-6.jpg" class="card-img-top" style={{height:"15rem"}} alt="..."/>
  <div class="card-body">
...
<div class="card m-5" style={{width: "15rem"}}>
  <img src="/img/product-7.jpg" class="card-img-top" style={{height:"15rem"}} alt="..."/>
  <div class="card-body">
...
<div class="card m-5" style={{width: "15rem"}}>
  <img src="/img/product-8.jpg" class="card-img-top" style={{height:"15rem"}} alt="..."/>
  <div class="card-body">
